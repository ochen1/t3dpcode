...
export const ClientSettingsSchema = Schema.Struct({
  ...
  playSoundOnAgentCompletion: Schema.Boolean.pipe(
...
export const ServerSettings = Schema.Struct({
  ...
  enableGitCheckpointing: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
  /**
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  enableGitCheckpointing: Schema.optionalKey(Schema.Boolean),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  playSoundOnAgentCompletion: Schema.optionalKey(Schema.Boolean),
