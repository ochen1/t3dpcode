...
export function createOrchestrationEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    externalConversations: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:orchestration:external-conversations",
      tag: ORCHESTRATION_WS_METHODS.listExternalConversations,
      staleTimeMs: 0,
      idleTtlMs: 0,
    }),
    importExternalConversation: createEnvironmentRpcCommand(runtime, {
      label: "environment-data:orchestration:import-external-conversation",
      tag: ORCHESTRATION_WS_METHODS.importExternalConversation,
    }),
