...
import {
  ...
  type RollbackThreadConversationInput,
...
export type {
  ...
  RollbackThreadConversationInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    rollbackConversation: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:rollback-conversation",
      execute: (input: RollbackThreadConversationInput) => rollbackThreadConversation(input),
      scheduler,
      concurrency,
    }),
