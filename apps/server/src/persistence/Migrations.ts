...
import Migration0033 from "./Migrations/033_BackfillProjectionThreadLatestTurn.ts";
import Migration0034 from "./Migrations/034_ProjectionQueuedTurns.ts";
...
export const migrationEntries = [
  ...
  [33, "BackfillProjectionThreadLatestTurn", Migration0033],
  [34, "ProjectionQueuedTurns", Migration0034],
] as const;
