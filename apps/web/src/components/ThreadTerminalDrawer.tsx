...
export function TerminalViewport({
  ...
  useEffect(() => {
    ...
    const themeObserver = new MutationObserver(() => {
      const activeTerminal = terminalRef.current;
      if (!activeTerminal) return;
      activeTerminal.options.fontFamily = getTerminalFontFamily();
      activeTerminal.options.fontSize = getTerminalFontSizePx();
      activeTerminal.options.fontWeight = getTerminalFontWeight();
      activeTerminal.options.fontWeightBold = getTerminalBoldFontWeight();
