...
const SETTINGS_CARD_ROW_CLASS_NAME = "px-4 py-3.5 sm:px-5";
const SETTINGS_CONTROL_RADIUS_CLASS_NAME = "rounded-lg";
...
export function ThemePackEditor({
  ...
  const handleCopy = async () => {
    try {
      await writeTextToClipboard(exportThemeString(variant), "theme");
      toastManager.add({
        type: "success",
        title: "Theme copied",
