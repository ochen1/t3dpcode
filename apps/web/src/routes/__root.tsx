...
import { AgentBrowserNotificationObserver } from "../components/AgentBrowserNotificationObserver";
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        {primaryEnvironmentAuthenticated ? <AgentBrowserNotificationObserver /> : null}
        {appShell}
      </AnchoredToastProvider>
    </ToastProvider>
  );
