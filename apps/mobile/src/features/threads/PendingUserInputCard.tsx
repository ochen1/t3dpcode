    ...
    >
      ...
      <View className="flex-row gap-2.5">
        <Pressable
          ...
          className="items-center justify-center rounded-2xl border border-adaptive-neutral-300-white-a10 bg-adaptive-white-neutral-950-a70 px-4 py-3.5"
          disabled={props.respondingUserInputId === props.pendingUserInput.requestId}
          onPress={props.onCancel}
        >
          <Text className="font-t3-extrabold text-sm text-adaptive-neutral-700-200">Cancel</Text>
        </Pressable>
        <Pressable
          accessibilityRole="button"
          className={cn(
